...
public class calculator_use implements ActionListener
{       
Font font = new Font("宋体",Font.BOLD,18);//添加字体font
		...
		double num1,num2,result=0;//成员变量保存运算数据及结果
		int i;  // 判断运算操作符
		int j=0;  //判断数字是否为运算结果
		int times=0;//统计.的使用次数
		//String record="";
	public calculator_use() //构造函数
    { 
		      ...
		      m.addMenuListener(new MenuListener(){
				...
				public void menuSelected(MenuEvent e) {
					// TODO 自动生成的方法存根
					write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "M");	
				}
		         });
		      ...
		      m1.addMouseListener(new MouseListener(){
					public void mouseClicked(MouseEvent e) {
						    ...
						    if(j>=1)
						    {
						    	...
						    	t.setText(s1);
						    	write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "R");
						    	}					    
					}
	...
	{  	
		if(e.getActionCommand().equals("0"))
		    ...
		    write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "0");
		    }
		    ...
		    {   if(j==0)   
		        {String a=t.getText();
		    	  ...
		    	  {t.setText("1");
		    	  j=0;}
		    write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "1");
		    }  
		    ...
		    {   if(j==0)
	    	  ...
	    	  t.setText(a+"2"); }
		    	  ...
		    	  {t.setText("2");
		    	  j=0;}
		    write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "2");
		    }
	        ...
	        {   if(j==0) 
			 {String a=t.getText();
	    	  t.setText(a+"3"); }
		    	  ...
		    	  {t.setText("3");
		    	  j=0;}
	        write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "3");
	        }
	        ...
	        {   if(j==0)
			 {String a=t.getText();
	    	  t.setText(a+"4"); }
	            ...
	            {t.setText("4");
		    	  j=0;}
	        write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "4");
	        }
		    ...
		    {   if(j==0)
		      {String a=t.getText();
		        ...
		        {t.setText("5");
		    	  j=0;}
		    write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "5");
            }
		    ...
		    {   if(j==0)
		     {String a=t.getText();
		        ...
		        {t.setText("6");
		    	  j=0;}
		    write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "6");
            }
		    ...
		    {   if(j==0)
		     {String a=t.getText();
		        ...
		        {t.setText("7");
		    	  j=0;}
		    write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "7");
            }
		    ...
		    {   if(j==0)
		     {String a=t.getText();
		        ...
		        {t.setText("8");
		    	  j=0;}
		    write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "8");
            }
		    ...
		    {   if(j==0)
		     {String a=t.getText();
		        ...
		        {t.setText("9");
		    	  j=0;}
		    write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "9");
            }
	        ...
	        { 
	          ...
	          j=1;
	          write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "π");
	        }//设置π的值，不允许π后加数字
	    ...
	    { if(j==0)//不是结果
	       ...
	       {  if(a.length()==0)//开始输入“.”显示为“0.”
	    	...
	    	{t.setText("0.");
	         j=0;}//是结果后输入‘.’显示为“0.”
	    write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", ".");
	    }
		
		else if(e.getActionCommand().equals("CE"))
	    {   j=0;
			times=0;
			write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "C");
			t.setText("");
		}//清除文本框并初始化j,times,表示当前不是结果且无小数点
	    ...
	    {     j=0;
	          ...
	          String a=t.getText();
	          num1=Double.parseDouble(a);
	          //System.out.print(num1+"log");
	    	  t.setText(""); 
	          i=6;
	          write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "log");
	    }
	    ...
	    {
			write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "S");
			new caidanxiang();
		}  //通过caidanxiang类新建窗口
	    ...
	    {
			write_file.writeTxt("C:\\Users\\yuanlin\\Desktop\\record.log", "T");
			f.setVisible(false);
	    }//退出窗体   
	} 
}
...
class caidanxiang{
	...
	String s=null;
	int i=0;
	String path="C:\\Users\\yuanlin\\Desktop\\path\\";
	JTextArea a2=new JTextArea(2,16);//文本域为给出说明信息
	caidanxiang()//构造函数
	{
		...
		a2.setBackground(new Color(238,232,170));
